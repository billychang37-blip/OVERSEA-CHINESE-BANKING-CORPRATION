    ...
    try {
      if (process.env.RESEND_API_KEY) {
        ...
        await resend.emails.send({
          ...
          to: formData.email,
          subject: 'OCBC Digital - Your Secure Access Credentials',
          html: `
            <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #E5E7EB; border-radius: 6px; overflow: hidden; background-color: #ffffff;">
              <div style="background-color: #ffffff; padding: 20px 24px; border-bottom: 3px solid #E81C24;">
                <img src="https://fvtvkpgyqpqyqaoabfna.supabase.co/storage/v1/object/public/assets/logo_main.png" alt="OCBC Bank" style="height: 65px; object-fit: contain;" />
              </div>
              ...
              <div style="padding: 24px; color: #333333;">
                ...
                <div style="background-color: #FAFAFA; border: 1px solid #E5E7EB; border-radius: 4px; padding: 20px; margin: 20px 0;">
                  <h3 style="margin: 0 0 12px 0; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; color: #6b7280; border-bottom: 1px solid #E5E7EB; padding-bottom: 10px;">Your Secure Access Details</h3>
                ...
                <p style="font-size: 13px; line-height: 1.5; margin: 0 0 24px 0; color: #4b5563; background-color: #f0fdf4; border-left: 3px solid #22c55e; padding: 10px 12px;">
                  <strong>Security Notice:</strong> Please memorize your PIN and delete this email. OCBC staff will never ask you for your PIN.
                </p>
                
                <div style="text-align: left; margin-bottom: 8px;">
                  <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/login" style="background-color: #E81C24; color: #ffffff; padding: 12px 24px; text-decoration: none; font-weight: 600; font-size: 14px; border-radius: 4px; display: inline-block;">Proceed to Secure Login</a>
                </div>
              </div>
