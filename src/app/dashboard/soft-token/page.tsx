  ...
  return (
    <div className="px-6 md:px-10 pb-20 pt-8 w-full animate-in fade-in duration-500 flex justify-center min-h-screen">
      <div className="w-full max-w-[1000px] flex flex-col gap-6">
        ...
        {/* Header Hero */}
        <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] rounded-[2rem] p-10 md:p-12 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <h1 className="text-[36px] md:text-[42px] font-bold mb-4 tracking-tight leading-tight">
        ...
        <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-sm border border-gray-100">
          ...
          {/* Charge Banner */}
          <div className="bg-[#FFF4F4] border border-[#FFE5E8] rounded-2xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
