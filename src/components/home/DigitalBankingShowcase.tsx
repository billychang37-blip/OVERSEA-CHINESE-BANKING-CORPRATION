    ...
    <section className="py-24 lg:py-32 bg-white relative overflow-hidden">
      ...
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          */}
          <div className="lg:col-span-5 relative flex justify-center lg:justify-end items-center lg:h-full">
            <motion.div
                ...
                {timelineFeatures.map((feature, idx) => (
                  ...
                  >
                    ...
                    <div className="pt-0.5 pl-3">
                      <h3 className="text-[22px] font-bold text-slate-900 mb-2 tracking-tight">
                        {feature.title}
                      </h3>
